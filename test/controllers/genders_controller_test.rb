...
class GendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gender" do
    assert_difference('Gender.count') do
      post genders_url, params: { gender: { abbreviation_1: @gender.abbreviation_1, description: @gender.description, name: @gender.name } }
    end
  ...
  test "should update gender" do
    patch gender_url(@gender), params: { gender: { abbreviation_1: @gender.abbreviation_1, description: @gender.description, name: @gender.name } }
